...
1. **After Each Change:**
    ...
    - Append a new entry at the TOP of `collab_progress/CHANGELOG.md` with date/time and links to your detailed note(s). Use **IST** (India Standard Time, UTC+05:30) for the time field.
...
- [ ] Add changelog entry at the TOP of `collab_progress/CHANGELOG.md` (include date and **IST** time, branch/PR, links to notes, verification)
- [ ] Run tests and include verification outcome
